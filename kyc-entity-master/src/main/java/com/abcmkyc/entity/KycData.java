...
public class KycData {
	...
	@Column(name = "allow_download", length = 30)

	private String allowDocument;
	
	
	@Column(name = "document_hash", columnDefinition = "LONGTEXT")
	...
	@Column(name = "final_sign_status", columnDefinition = "BOOLEAN DEFAULT FALSE")
	private boolean finalSignStatus;
	
	
	
	@Column(name = "white_label", length =1000)
